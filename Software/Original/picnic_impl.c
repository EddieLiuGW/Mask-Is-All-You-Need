...
void LowMCEncState(const uint32_t* plaintext, uint32_t* key, paramset_t* params, uint32_t* output)
{
    ...
    //}
    matrix_mul(roundKey, key, KMatrix(0, params), params);
    //printf("\nLowmc_Roundkey = key * K0: \n");
    //for (size_t i = 0; i < params->stateSizeBits; i++)
    //{
    //    printf("%d", getBit(roundKey, i));
    //}
    //printf("\nLowmc_state = plaintext: \n");
    //for (size_t i = 0; i < params->stateSizeBits; i++)
    //{
    //    printf("%d", getBit(state, i));
    //}
    xor_array(state, state, roundKey, params->stateSizeWords);
    //printf("\nLowmc_state = plaintext xor roundkey: \n");
    //for (size_t i = 0; i < params->stateSizeBits; i++)
    //{
    //    printf("%d", getBit(state, i));
    //}
    for (uint32_t r = 1; r <= params->numRounds; r++) {
        matrix_mul(roundKey, key, KMatrix(r, params), params);
        //printf("\nLowmc_Roundkey = key * K%d: \n", r);
        //for (size_t i = 0; i < params->stateSizeBits; i++)
        //{
        //    printf("%d", getBit(roundKey, i));
        //}
        /* The state before the S-boxes */
        memcpy(output + ((r - 1) * params->stateSizeWords), &state, params->stateSizeWords * (sizeof(uint32_t)));
        ...
        substitution(state, params);
        //printf("\nafter_sbox_state%d: \n", r);
        //for (size_t i = 0; i < params->stateSizeBits; i++)
        //{
        //    printf("%d", getBit(&state, i));
        //}
        matrix_mul(state, state, LMatrix(r - 1, params), params);
        //printf("\nafter_LMatrix_state%d: \n", r);
        //for (size_t i = 0; i < params->stateSizeBits; i++)
        //{
        //    printf("%d", getBit(&state, i));
        //}
        ...
        xor_array(state, state, roundKey, params->stateSizeWords);
        //printf("\nafter_xorRCxorRoundKey_state%d: \n", r);
        //for (size_t i = 0; i < params->stateSizeBits; i++)
        //{
        //    printf("%d", getBit(&state, i));
        //}
