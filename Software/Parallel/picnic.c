                  ...
                  picnic_privatekey_t* sk)
{
    ...
    for (size_t i = 0; i < paramset.stateSizeBits; i++)
    {

        setBit(sk->data, i, ((i * i * i - 18) % (i + 10086)) % 2);

    }
    printf("\nk: ");
    for (size_t i = 0; i < paramset.stateSizeBits; i++)
    {
        printf("%d", getBit(sk->data, i));
    ...
    for (size_t i = 0; i < paramset.stateSizeBits; i++)
    {
        ...
        setBit(pk->plaintext, i, ((i * i * i) % (i + 10086)) % 2);

    }
    printf("\np: ");
    for (size_t i = 0; i < paramset.stateSizeBits; i++)
    {
        printf("%d", getBit(pk->plaintext, i));
    }
    ...
    for (size_t i = 0; i < paramset.stateSizeBits; i++)
    {
        printf("%d", getBit(pk->ciphertext, i));
    }
